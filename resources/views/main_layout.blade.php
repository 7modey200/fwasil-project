...
<head>
    ...
    <title>{{ $title ?? 'شركة فواصل القابضة' }}</title>
    <style>
        body {
    ...
    <div class="main-content">
        @if(request()->is('contact'))
            <div class="contact-container">
                <h1 class="contact-heading">{{ $title ?? '' }}</h1>
        ...
        @else
            <div class="content-container">
                <h1 class="main-heading">{{ $title ?? 'شركة فواصل القابضة' }}</h1>



                <div class="general-content">
                    {!! $content ?? 'مرحباً بكم في شركة فواصل القابضة. نحن نعمل على تقديم أفضل الخدمات في جميع القطاعات.' !!}
                </div>
            </div>
        @endif
    </div>
